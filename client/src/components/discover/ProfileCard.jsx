...
const FALLBACK_PHOTOS = ['/assets/bunny1.jpg', '/assets/bunny2.jpg', '/assets/bunny3.jpg'];
...
const ProfileCard = ({ user, onPass, onLike, onSuperlike }) => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      const rawList =
        Array.isArray(user.photos) && user.photos.length > 0 ? user.photos : FALLBACK_PHOTOS;
  ...
  return (
    <div className="relative bg-white border border-gray-200 rounded-lg shadow-md overflow-hidden w-full">
      ...
      <div className="p-4 space-y-4">
        ...
        {/* Sijainti */}
        <LocationText city={user.city} region={user.region} country={user.country} />
