    ...
    >
      <div className="w-full px-8 max-w-none overflow-x-auto">
        ...
        >
          ...
          <div>
            ...
            <ul className="space-y-1">
              ...
              <li><Link to="/press" className="hover:underline">{t("press")}</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-1">
              ...
              <li><Link to="/cookies" className="hover:underline">{t("cookies")}</Link></li>
              <li><Link to="/community" className="hover:underline">{t("community")}</Link></li>
              <li><Link to="/health-policy" className="hover:underline">{t("health")}</Link></li>
              <li><Link to="/colorado-policy" className="hover:underline">{t("coInfo")}</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-1">
              <li><Link to="/support" className="hover:underline">{t("support")}</Link></li>
              <li><Link to="/security" className="hover:underline">{t("security")}</Link></li>
              <li><Link to="/safety-tips" className="hover:underline">{t("safety")}</Link></li>
              <li><Link to="/impressum" className="hover:underline">{t("impressum")}</Link></li>
            </ul>
          </div>
        ...
        <div className="text-center text-gray-200 text-xs mt-10 leading-tight">
          <p>© {new Date().getFullYear()} DateSite – {t("rights")}</p>
