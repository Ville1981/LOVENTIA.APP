...
export const regionCities = {
  ...
  "Bangladesh": {
    "Barisal": ["Barisal", "Bhola", "Jhalokathi", "Patuakhali"],
    "Chattogram": ["Bandarban", "Chattogram", "Cox's Bazar", "Rangamati"],
    "Dhaka": ["Banani", "Dhaka", "Gulshan", "Mirpur"],
    "Khulna": ["Bagerhat", "Jessore", "Khulna", "Satkhira"],
    "Rajshahi": ["Bogra", "Natore", "Pabna", "Rajshahi"]
  },
  ...
  "Indonesia": {
    "Jakarta": ["Central Jakarta", "South Jakarta", "East Jakarta", "West Jakarta"],
    "West Java": ["Bandung", "Bekasi", "Bogor", "Depok"],
    "Central Java": ["Semarang", "Surakarta", "Magelang", "Tegal"],
  ...
  "Iran": {
    ...
    "Qom": ["Qom", "Salafchegan", "Kahak", "Dastgerd"],
    "Shiraz": ["Shiraz", "Marvdasht", "Kazerun", "Jahrom"],
  ...
  "Iraq": {
    ...
    "Kirkuk": ["Kirkuk", "Dibis", "Hawija", "Altun Kupri"],
    "Mosul": ["Mosul", "Bashiqa", "Bartella", "Qayyarah"]
  },
  "India": {
  ...
  "Israel": {
    "Beersheba": ["Beersheba City Center", "Ramot", "Negev"],
    "Haifa": ["Hadar", "Carmel", "Bat Galim"],
    "Jerusalem": ["Old City", "West Jerusalem", "East Jerusalem", "Gilo"],
    "Tel Aviv": ["Jaffa", "Ramat Aviv", "Florentin", "Neve Tzedek"]
  },
  "Israel-Beersheba": ["Beersheba", "Dimona", "Ofakim", "Rahat"],
  ...
  "Japan": {
    ...
    "Okinawa": ["Naha", "Okinawa City", "Uruma", "Ginowan"],
  ...
  "China": {
    ...
    "Sichuan": ["Chengdu", "Mianyang", "Leshan", "Deyang"],
    "Zhejiang": ["Hangzhou", "Ningbo", "Wenzhou", "Jinhua"],
    "Hubei": ["Wuhan", "Huangshi", "Xiangyang", "Yichang"],
  ...
  "Norway": {
    ...
    "Troms og Finnmark": ["Tromsø", "Alta", "Vadsø", "Hammerfest"],
    "Vestland": ["Voss", "Leikanger", "Førde", "Florø"],
    "Innlandet": ["Hamar", "Gjøvik", "Lillehammer", "Elverum"],
    "Agder": ["Kristiansand", "Arendal", "Grimstad", "Farsund"],
    "Nordland": ["Bodø", "Narvik", "Mo i Rana", "Sortland"]
  },
  "Pakistan": {
    "Punjab": ["Faisalabad", "Lahore", "Multan", "Rawalpindi"],
    "Sindh": ["Hyderabad", "Karachi", "Larkana", "Sukkur"],
  ...
  "Sweden": {
    ...
    "Uppsala": ["Uppsala", "Enköping", "Tierp", "Östhammar"],
    "Örebro": ["Örebro", "Kumla", "Hallsberg", "Askersund"],
    "Värmland": ["Karlstad", "Arvika", "Kristinehamn", "Torsby"],
  ...
  "Thailand": {
    ...
    "Pattaya": ["Pattaya", "Jomtien", "Naklua", "Bang Lamung"],
  ...
  "Turkey": {
    ...
    "Antalya": ["Antalya", "Alanya", "Manavgat", "Kemer"],
  ...
  "Vietnam": {
    ...
    "Ho Chi Minh City": ["Ho Chi Minh City", "District 1", "District 3", "District 7"],
